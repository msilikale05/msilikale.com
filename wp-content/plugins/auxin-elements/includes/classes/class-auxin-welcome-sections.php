...
class Auxin_Welcome_Sections {
    ...
    public function add_section_go_pro( $sections ){
        ...
        $sections['go_pro'] = array(
            ...
            'description'    => '',
            'url'            => esc_url( 'http://phlox.pro/go/?utm_source=phlox-welcome&utm_medium=phlox-free&utm_campaign=phlox-go-pro&utm_content=welcome-tab' ), // optional
            'target'         => '_blank',
    ...
    function append_changelog( $tab ){
        ...
        if( false === $changelog_info = get_transient( "auxin_{$theme_id}_remote_changelog" ) ){
            ...
            $changelog = $this->get_remote_changelog( $theme_id );
        ...
        if( $changelog_info && ! empty( $changelog_info['version'] ) && ! empty( $changelog_info['changelog'] ) ){ ?>
            <div class="aux-changelog-wrap">
                ...
                <div class="aux-changelog-content">
                    <!-- '<a class="aux-changelog-headline" href="http://support.averta.net/en/changelog/'.$theme_id.'/" target="_blank">' . __( "What's New in version", 'auxin-elements') . ' '. $changelog_info['version'] . '</a>'; -->
                    <div class="aux-changelog-list">
