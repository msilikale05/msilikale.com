        								...
        								<div class="aux-plugin aux-table-row aux-iso-item <?php echo esc_attr( $filter_terms ); ?>" data-slug="<?php echo esc_attr( $slug ); ?>">
        						            ...
        						            <div class="thumbnail column-thumbnail aux-column-cell" data-colname="Thumbnail">
        						            	<?php
        								            ...
        								            if( in_array( $plugin['slug'], array("js_composer", "Ultimate_VC_Addons", "masterslider", "go_pricing", "auxin-pro-tools", "auxin-shop", "auxin-the-news", "waspthemes-yellow-pencil") ) ) {
                    ...
                    ?>
                        <div class="aux-grid-item-footer">
                            ...
                            if( $is_demo_allowed ) {
                                ...
                                $import_btn_url = esc_url( 'http://phlox.pro/go/?utm_source=phlox-welcome&utm_medium=phlox-free&utm_campaign=phlox-go-pro&utm_content=demo-unlock&utm_term='. $args['site_id'] );
                            }
